...
CODEGEN=1 NO_LLVM=1 CC=~/.symbolica/build/clang CFLAGS="-O0 -Xclang -disable-O0-optnone -fPIC -U__GNUC__" ./configure --disable-shared --prefix=$(eval echo ~/.symbolica/build/sysroot) --exec-prefix=$(eval echo ~/.symbolica/build/sysroot/bin)
