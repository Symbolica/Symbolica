...
public class FloatToUnsignedTests
{
        ...
        IValue value1)
    {
        ...
        using var bv0 = FloatToUnsigned.Create(size, value0).AsBitVector(solver);
        using var result0 = bv0.Simplify();

        using var bv1 = FloatToUnsigned.Create(size, value1).AsBitVector(solver);
        ...
        IValue value1)
    {
        ...
        using var b0 = FloatToUnsigned.Create(size, value0).AsBool(solver);
        using var result0 = b0.Simplify();

        using var b1 = FloatToUnsigned.Create(size, value1).AsBool(solver);
        ...
        IValue value1)
    {
        ...
        using var f0 = FloatToUnsigned.Create(size, value0).AsFloat(solver);
        using var result0 = f0.Simplify();

        using var f1 = FloatToUnsigned.Create(size, value1).AsFloat(solver);
