...
public class TruncateTests
{
        ...
        IValue value1)
    {
        ...
        using var bv0 = Truncate.Create(size, value0).AsBitVector(context);
        using var result0 = bv0.Simplify();

        using var bv1 = Truncate.Create(size, value1).AsBitVector(context);
        ...
        IValue value1)
    {
        ...
        using var b0 = Truncate.Create(size, value0).AsBool(context);
        using var result0 = b0.Simplify();

        using var b1 = Truncate.Create(size, value1).AsBool(context);
