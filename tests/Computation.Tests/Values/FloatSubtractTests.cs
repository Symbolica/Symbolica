...
public class FloatSubtractTests
{
        ...
        IValue left1, IValue right1)
    {
        ...
        using var bv0 = FloatSubtract.Create(left0, right0).AsBitVector(solver);
        using var result0 = bv0.Simplify();

        using var bv1 = FloatSubtract.Create(left1, right1).AsBitVector(solver);
        ...
        IValue left1, IValue right1)
    {
        ...
        using var b0 = FloatSubtract.Create(left0, right0).AsBool(solver);
        using var result0 = b0.Simplify();

        using var b1 = FloatSubtract.Create(left1, right1).AsBool(solver);
        ...
        IValue left1, IValue right1)
    {
        ...
        using var f0 = FloatSubtract.Create(left0, right0).AsFloat(solver);
        using var result0 = f0.Simplify();

        using var f1 = FloatSubtract.Create(left1, right1).AsFloat(solver);
