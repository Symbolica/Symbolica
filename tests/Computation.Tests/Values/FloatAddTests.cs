...
public class FloatAddTests
{
        ...
        IValue left1, IValue right1)
    {
        ...
        using var bv0 = FloatAdd.Create(left0, right0).AsBitVector(context);
        using var result0 = bv0.Simplify();

        using var bv1 = FloatAdd.Create(left1, right1).AsBitVector(context);
        ...
        IValue left1, IValue right1)
    {
        ...
        using var b0 = FloatAdd.Create(left0, right0).AsBool(context);
        using var result0 = b0.Simplify();

        using var b1 = FloatAdd.Create(left1, right1).AsBool(context);
        ...
        IValue left1, IValue right1)
    {
        ...
        using var f0 = FloatAdd.Create(left0, right0).AsFloat(context);
        using var result0 = f0.Simplify();

        using var f1 = FloatAdd.Create(left1, right1).AsFloat(context);
