...
public class SignedToFloatTests
{
        ...
        IValue value1)
    {
        ...
        using var bv0 = SignedToFloat.Create(size, value0).AsBitVector(context);
        using var result0 = bv0.Simplify();

        using var bv1 = SignedToFloat.Create(size, value1).AsBitVector(context);
        ...
        IValue value1)
    {
        ...
        using var b0 = SignedToFloat.Create(size, value0).AsBool(context);
        using var result0 = b0.Simplify();

        using var b1 = SignedToFloat.Create(size, value1).AsBool(context);
        ...
        IValue value1)
    {
        ...
        using var f0 = SignedToFloat.Create(size, value0).AsFloat(context);
        using var result0 = f0.Simplify();

        using var f1 = SignedToFloat.Create(size, value1).AsFloat(context);
