...
public class FloatPowerTests
{
        ...
        IValue left1, IValue right1)
    {
        ...
        using var bv0 = FloatToSigned.Create(real0.Size, real0).AsBitVector(solver);
        using var result0 = bv0.Simplify();

        using var bv1 = FloatToSigned.Create(real1.Size, real1).AsBitVector(solver);
        ...
        IValue left1, IValue right1)
    {
        ...
        using var b0 = FloatToSigned.Create(real0.Size, real0).AsBool(solver);
        using var result0 = b0.Simplify();

        using var b1 = FloatToSigned.Create(real1.Size, real1).AsBool(solver);
        ...
        IValue left1, IValue right1)
    {
        ...
        using var f0 = FloatToSigned.Create(real0.Size, real0).AsFloat(solver);
        using var result0 = f0.Simplify();

        using var f1 = FloatToSigned.Create(real1.Size, real1).AsFloat(solver);
