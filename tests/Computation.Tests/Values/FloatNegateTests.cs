...
public class FloatNegateTests
{
        ...
        IValue value1)
    {
        ...
        using var bv0 = FloatNegate.Create(value0).AsBitVector(context);
        using var result0 = bv0.Simplify();

        using var bv1 = FloatNegate.Create(value1).AsBitVector(context);
        ...
        IValue value1)
    {
        ...
        using var b0 = FloatNegate.Create(value0).AsBool(context);
        using var result0 = b0.Simplify();

        using var b1 = FloatNegate.Create(value1).AsBool(context);
        ...
        IValue value1)
    {
        ...
        using var f0 = FloatNegate.Create(value0).AsFloat(context);
        using var result0 = f0.Simplify();

        using var f1 = FloatNegate.Create(value1).AsFloat(context);
