...
{
    internal sealed class SymbolicArbitraryExpression : SymbolicExpression
    {
        private SymbolicArbitraryExpression(IContextFactory contextFactory, ICollectionFactory collectionFactory,
        ...
        {
            return new SymbolicArbitraryExpression(contextFactory, collectionFactory,
        ...
        {
            var unconstrained = new SymbolicArbitraryExpression(contextFactory, collectionFactory,
